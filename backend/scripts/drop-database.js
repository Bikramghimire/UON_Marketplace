...
const main = async () => {
  ...
  if (dropAll) {
    console.log('⚠️  WARNING: This will DROP all tables (delete structure and data)!\n');
  } else {
    console.log('⚠️  WARNING: This will TRUNCATE all tables (delete data, keep structure)!\n');
  }
